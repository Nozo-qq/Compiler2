// Generated from C:/Projects/CompilerProject/src/antlr/grammar/flask/FlaskExprLexer.g4 by ANTLR 4.13.2
...
public class FlaskExprLexer extends Lexer {
	...
	public Vocabulary getVocabulary() {
	    ...
	    void handleNewline() {
	        ...
	        if (blockExpected) {
	            ...
	            if (!indents.isEmpty() && indents.peek() != indentLevel) {
	                    throw new RuntimeException("Inconsistent indentation");
	            }
	        }
	    }
	...
	public FlaskExprLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "FlaskExprLexer.g4"; }
